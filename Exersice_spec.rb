...
describe "get hr data" do
  ...
  it "should be able to decide hr on intervall basis" do
    ...
    @exersice.get_hr_at("2010-01-01T12:00:01Z").should be == 1
    @exersice.get_hr_at("2010-01-01T12:00:02Z").should be == 1
    @exersice.get_hr_at("2010-01-01T12:00:03Z").should be == 1
    @exersice.get_hr_at("2010-01-01T12:00:04Z").should be == 1
    @exersice.get_hr_at("2010-01-01T12:00:05Z").should be == 2
    @exersice.get_hr_at("2010-01-01T12:00:06Z").should be == 2
    @exersice.get_hr_at("2010-01-01T12:00:07Z").should be == 2
    @exersice.get_hr_at("2010-01-01T12:00:08Z").should be == 2
    @exersice.get_hr_at("2010-01-01T12:00:09Z").should be == 2
